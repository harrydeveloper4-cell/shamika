...
<body class="h-full font-sans antialiased text-slate-100 bg-slate-950" x-data="{ sidebarOpen: false }">
    ...
    @hasanyrole('admin|property-team')
    <div>
        <p class="px-3 text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-3">Field Operations</p>
        <div class="space-y-1">
            <a href="{{ route('inspections.index') }}" class="flex items-center px-3.5 py-2.5 rounded-xl text-sm font-semibold text-slate-400 hover:text-white hover:bg-slate-800">
    ...
    <div>
        ...
        <div class="space-y-1">
            <a href="{{ route('renter.properties.index') }}" class="flex items-center px-3.5 py-2.5 rounded-xl text-sm font-semibold text-slate-400 hover:text-white hover:bg-slate-800">
